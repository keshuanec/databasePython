"""
Vaše údaje potřebujeme, abychom mohli provést řadu dotazů. Napište funkci insert_data, která bude přijímat tyto argumenty:

base - základní třídu modelu, jehož instanci chceme vytvořit
params - slovník s konkrétními parametry vytvářeného objektu
Otestujte funkci proti poskytnutým datům:
"""
